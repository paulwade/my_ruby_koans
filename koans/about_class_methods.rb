...
class AboutClassMethods < EdgeCase::Koan
  ...
  #
  # ENLIGHTENMENT:
  # I tried researching this to see if there was a technical reason to choose one over
  # the other but couldn't find anything.  Given that it seems to be an aesthetic choice
  # I would prefer the first method since it seems easier to read to me.
