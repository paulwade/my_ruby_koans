...
class AboutMessagePassing < EdgeCase::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    #
    # ENLIGHTENMENT:
    # This is a trick question which you can only answer if you know a bit
    # of the history of Ruby.  Originally Ruby only had #send but it was
    # later realized that the method name #send could be useful in other
    # contexts so it was decided that another #send method was needed to
    # allow programmers to override the default #send method.  Hence
    # #__send__ was born.
