...
class AboutIteration < EdgeCase::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # ENLIGHTENMENT:
    #
    # Once again I had to find Zen somewhere else because I didn't get it:
  ...
  #
  # ENLIGHTENMENT 1:
  # I'm guessing that doing it this way automatically closes the file
  # when the block is done and the other way requires the rubyist to
  # manually close the file.
  # ENLIGHTENMENT 2:
  # After the about_sandwich_code koan I see I was at least partially
  # right.  File.open is sandwich code which ensures the file is closed
  # when it's done.
