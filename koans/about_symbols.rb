...
class AboutSymbols < EdgeCase::Koan
  ...
  # ENLIGHTENMENT:
  #
  # Once again StackOverflow comes to the rescue.  If we tried to use
  #   all_symbols = Symbol.all_symbols
  #   assert_equal true, all_symbols.include?(:test_method_names_become_symbols)
  # It would always return true since the act of testing for it automatically
  # creates it.
  ...
  # ENLIGHTENMENT:
  #
  # Symbols are only created once in memory and the memory they use is
  # not released until the program exits.
