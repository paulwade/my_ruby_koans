...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # ENLIGHTENMENT:
    #
    # I figured the answer was "never" but I doubted myself.  Confirmed
    # at StackOverflow. It would never fail to match.
  ...
  # ENLIGHTENMENT:
  #
  # Because they take everything they can get.
  ...
  # ENLIGHTENMENT:
  #
  # character class behaves like "and", alternation is "or".
  ...
  # ENLIGHTENMENT:
  #
  # Those last two were pretty confusing.  So the regex /(t\w)/ returns the
  # matching expression as $1.  Then the array notation in the curly braces
  # says to use the first character of that $1 variable to replace the word
  # matched by the regex (in this case "two") in the sub (or gsub) operation.
  # the regex is returning "two" and sub/gsub is replace that with "t"
